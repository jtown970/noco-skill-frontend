...
const TermsOfServiceModal = ({ isOpen, onClose }) => {
  return (
    <div className={`terms-modal ${isOpen ? "open" : ""}`}>
      <div className="modal-content">
        <h2>Terms of Service</h2>
        <p>[Noco Skills] Terms of Service
...
By using the Marketplace, you acknowledge that you have read, understood, and agreed to these Terms of Service.</p>
